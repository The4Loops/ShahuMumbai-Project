const g = (...args) => window.gtag && window.gtag(...args);
...
export const Ecom = {
  viewItem: (item) => track('view_item', { currency: 'INR', items: [toGaItem(item)] }),
...
export const UX = {
  ...
  selectPromotion: (name, creative, position) => track('select_promotion', { promotion_name: name, creative_name: creative, location_id: position }),
