...
const studios = [
  {
    ...
    image: "https://source.unsplash.com/600x400/?vintage,studio",
  },
  {
    name: "Goa Atelier",
    desc: "Our coastal retreat for designers, restorers, and creative minds — infused with local heritage.",
    image: "https://source.unsplash.com/600x400/?heritage,interior",
  },
];

function OurStudios() {
  return (
    <Layout>    <div className="bg-[#fff8f1] px-4 sm:px-10 py-16 text-[#2e2e2e] min-h-screen">
      <motion.div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
        {studios.map((studio, idx) => (
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <img src={studio.image} alt={studio.name} className="w-full h-60 object-cover" />
            <div className="p-6">
