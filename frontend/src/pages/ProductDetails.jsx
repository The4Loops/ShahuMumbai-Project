...
const dummyData = [
  {
    ...
    images: [
      require('../assets/images/product_images/dummyHandbag.jpeg'),
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="mt-4">
              ...
              <button className="bg-[#D4A5A5] hover:bg-[#C39898] text-white px-6 py-3 rounded-md transition font-semibold shadow">
                Add to Cart
              </button>
            </div>
          </div>
