...
exports.updateUserProfile = async (req, res) => {
  ...
  try {
    ...
    const request = req.dbPool.request()
      ...
      .input('NewsLetterSubscription', sql.Char(1), updates.NewsLetterSubscription == true ? 'Y' :'N')
      .input('EmailNotifications', sql.Char(1), updates.EmailNotifications == true ? 'Y' :'N')
      .input('PublicProfile', sql.Char(1), updates.PublicProfile == true ? 'Y' :'N')
